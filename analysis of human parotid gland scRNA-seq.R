...
VlnPlot(Normal, features = c("LPO","KRT19","ACTA2","COL1A1","CDH5","CD3D","KLRF1","CD79A","MZB1","LYZ"), pt.size = 0.000000001, combine = T)


markers.to.plot <- c("CD3D","LPO","CD79A","KLRF1","COL1A1","MZB1","LYZ","KRT7","CDH5","ACTA2")
...
FeaturePlot(Bothcombined, features = metrics)
